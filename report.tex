...
\title{\textbf{Báo Cáo Đồ Án Tốt Nghiệp} \\[0.5cm]
...
\author{
\begin{tabular}{ll}
\multicolumn{2}{c}{\textbf{SINH VIÊN THỰC HIỆN}} \\[0.3cm]
MSHV 1111 & Trí Đông \\
MSHV 2222 & Thành Phạm \\
MSHV 333  & Thu Thủy \\
MSHV 4444 & Nguyễn Tâm \\
MSHV 5555 & Justin \\[0.3cm]
\multicolumn{2}{c}{\textbf{GIẢNG VIÊN HƯỚNG DẪN}} \\[0.2cm]
\multicolumn{2}{c}{Trọng Nhân} \\[0.3cm]
\end{tabular} \\[0.3cm]
...
\midrule
0 & 3,276 & 9,830 & 820 & 2,458 \\
1 & 3,276 & 1,638 & 820 & 410 \\
2 & 3,276 & 3,932 & 820 & 983 \\
3 & 3,276 & 3,276 & 820 & 820 \\
4 & 3,276 & 2,948 & 820 & 738 \\
5 & 3,276 & 2,620 & 820 & 656 \\
6 & 3,276 & 2,620 & 820 & 656 \\
7 & 3,276 & 2,293 & 820 & 574 \\
8 & 3,276 & 3,276 & 820 & 820 \\
9 & 3,276 & 329 & 820 & 83 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Exp 1: FedAvg (Balanced) & 0.003913 & 0.004060 \\
Exp 2: FedAvg (Imbalanced) & 0.003188 & 0.003042 \\
\midrule
Cải thiện (Exp 2 vs Exp 1) & -18.52\% & -25.07\% \\
\bottomrule
\end{tabular}
\end{table}

\textbf{Quan sát:} Phản trực giác, phân phối không cân bằng cho kết quả tốt hơn phân phối cân bằng:

\begin{itemize}
    \item Eval loss của Non-IID (0.003042) thấp hơn IID (0.004060) đáng kể
    \item Training loss cũng thấp hơn (0.003188 vs 0.003913)
\end{itemize}
...
\midrule
Normal Sample & 0.065346 & < 0.079331 & \textcolor{green}{NORMAL} \\
Sensor Error & 0.455401 & > 0.079331 & \textcolor{red}{ANOMALY} \\
High Vibration & 0.252206 & > 0.079331 & \textcolor{red}{ANOMALY} \\
Negative Values & 0.101723 & > 0.079331 & \textcolor{red}{ANOMALY} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Phân tích:}
\begin{itemize}
    \item Normal sample có error (0.065) thấp hơn threshold đáng kể
    \item Anomaly samples có error cao gấp 1.3-5.8 lần threshold
    \item Sensor error (0.455) có error cao nhất, dễ detect nhất
    \item Negative values (0.102) gần threshold nhất, cần monitor cẩn thận
\end{itemize}
...
\midrule
Centralized & 0.0028 (ước tính) & Kém & Cao (raw data) \\
FL (IID) & 0.004060 & Tốt & Trung bình (models) \\
FL (Non-IID) & 0.003042 & Tốt & Trung bình (models) \\
DFL (ước tính) & 0.003-0.004 & Rất tốt & P2P local \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
    ...
    \item \textbf{So sánh hiệu suất} giữa IID và Non-IID data distribution, phát hiện rằng Non-IID đạt kết quả tốt hơn (eval loss 0.003042 vs 0.004060)
    \item \textbf{Đạt 100\% accuracy} trong anomaly detection với threshold dựa trên 95th percentile
    \item \textbf{Phân tích ứng dụng} của DFL trong các hệ thống IoT thực tế: Smart City, Smart Home, IIoT, WSN
\end{enumerate}

\textbf{Kết luận chính:} DFL là giải pháp khả thi và hiệu quả cho machine learning trên IoT, cung cấp privacy, fault tolerance, và low latency mà centralized approaches không đạt được.
