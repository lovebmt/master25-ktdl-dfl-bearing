...
\begin{itemize}
    \item Eval loss của Non-IID (0.003787) thấp hơn IID (0.004064) đáng kể (giảm 6.81\%)
...
\begin{enumerate}
    ...
    \item \textbf{So sánh hiệu suất} giữa IID và Non-IID data distribution, phát hiện rằng Non-IID đạt kết quả vượt trội với eval loss 0.003787 (thấp hơn 6.81\% so với IID 0.004064)
