...
\textbf{NASA Bearing Dataset \cite{qiu2006}:} Dữ liệu vibration từ 4 vòng bi được giám sát đến khi hỏng hoàn toàn. Mỗi sample có 8 channels (cảm biến) với 20480 data points mỗi channel.
\begin{figure}[H]
\centering
